...
public class GeometryDemo extends Activity {
	...
	public void addCustomElementsDemo() {
		...
		OverlayOptions ooDot = new DotOptions().center(llDot).radius(16).color(0xFF0000FF);
		mBaiduMap.addOverlay(ooDot);
		// 添加文字
		OverlayOptions ooText1 = new TextOptions().bgColor(0xAAFFFF00).fontSize(24).fontColor(0xFFFF00FF).text("K117").rotate(-30).position(llDot);
		...
		OverlayOptions ooText = new TextOptions().bgColor(0xAAFFFF00).fontSize(24).fontColor(0xFFFF00FF).text("百度地图SDK").rotate(-30).position(llText);
